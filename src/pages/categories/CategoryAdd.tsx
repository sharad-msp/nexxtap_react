...
import type { CreateCategoryRequest, CategoryAttribute, CategoryAttributeOption } from '@/types/category.types';
...
const CategoryAdd: React.FC = () => {
  ...
  usePageTitle({ title: 'Add Category' });
  ...
  const removeAttribute = (index: number) => {
    const attrId = attributes[index].id;
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Create a new product category with variants and options</p>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Add variants (Size, Color) or add-ons (Extras, Toppings) with preset options and prices
                  </p>
                </div>
