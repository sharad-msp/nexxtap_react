    ...
    <>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center mb-8 p-4 bg-gray-50 rounded-lg border border-gray-100 animate-fade">
          ...
          <Skeleton height={32} width={80} className="bg-blue-100" /> {/* Edit Product Button */}
        </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <div className="flex items-center gap-4">
                <Skeleton height={28} width="70%" /> {/* VAT Value */}
              ...
              <div className="flex items-center gap-4">
                <Skeleton height={28} width="70%" /> {/* Sales Tax Value */}
                <Skeleton height={16} width="20%" className="text-gray-400" /> {/* Excluded */}
              </div>
            </div>
            <div>
        ...
        <div className="p-6 bg-gray-50 rounded-lg clear-right border border-gray-100 animate-fade">
          ...
          <div className="space-y-4">
            <Skeleton height={40} width="30%" className="bg-blue-100 rounded-lg" /> {/* Edit Product Button */}
            <Skeleton height={40} width="25%" className="bg-gray-200 rounded-lg" /> {/* Back to Products Button */}
          </div>
        </div>
      </div>
    </>
